...
public class CommunityVO {
    ...
    private int com_view_count;
    private int com_like_count;
    private int com_report_count;
    private int com_comment_count;
    ...
    public int getCom_comment_count() {
        return com_comment_count;
    }

    public void setCom_comment_count(int com_comment_count) {
        this.com_comment_count = com_comment_count;
    }

    public int getCom_report_count() {
        return com_report_count;
    }

    public void setCom_report_count(int com_report_count) {
        this.com_report_count = com_report_count;
    }

    public int getCom_like_count() {
        return com_like_count;
    }

    public void setCom_like_count(int com_like_count) {
        this.com_like_count = com_like_count;
    }

    public int getCom_view_count() {
        return com_view_count;
    }

    public void setCom_view_count(int com_view_count) {

...
public class CommunityViewVO {
    ...
    private Date com_created_date;
    private String com_updated_id;
    private Date com_updated_date;
    ...
    public Date getCom_created_date() {
        return com_created_date;
    }

    public void setCom_created_date(Date com_created_date) {
    ...
    public Date getCom_updated_date() {
